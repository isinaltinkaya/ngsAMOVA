...
test:
	...
	echo "Test 1";
	./ngsAMOVA -doEM 1 -doAMOVA 1 -i test/test_s9_d1_1K.vcf -printMatrix 1 -isSim 1 -minInd 2 -doDist 1 -maxIter 100 -tole 1e-10 --hascolnames 1 -m test/metadata_with_header_1lvl.tsv -out test/testwd/test_s9_d1_1K_mtd1;
	...
	echo "Test 3";
	./ngsAMOVA -doEM 1 -doAMOVA 1 -i test/test_s9_d1_1K.vcf -isSim 1 -minInd 2 -doDist 1 -maxIter 100 -tole 1e-10  --hascolnames 1 -m test/metadata_with_header_2lvl.tsv -out test/testwd/test_s9_d1_1K_mtd2;
	...
	echo "Test 5";
	./ngsAMOVA -doEM 0 -doAMOVA 2 -i test/test_s9_d1_1K.vcf -isSim 1 -minInd 2 -doDist 1 -m test/metadata_with_header_1lvl.tsv -out test/testwd/test_s9_d1_1K_mtd1_gt;
	bash -c "diff test/testwd/test_s9_d1_1K_mtd1_gt.amova.csv test/reference/test_s9_d1_1K_mtd1_gt.amova.csv";
	echo "Test 6";
	./ngsAMOVA -doEM 1 -doAMOVA 1 -doDist 1 -maxIter 50 -tole 1e-5 -P 4 -i test/sim_demes_v2-model1-1-rep0-d2.bcf -m test/sim_demes_v2-model1_metadata_2lvl_with_header.tsv -o test/testwd/sim_demes_v2-model1-1-rep0-d2_maxIter50tole5;
	bash -c "diff test/testwd/ test/reference/sim_demes_v2-model1-1-rep0-d2_maxIter50tole5.amova.csv";
