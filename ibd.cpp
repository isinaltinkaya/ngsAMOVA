		...
		if (args->doIbd == 1) {
			...
			do {
				...
				for (int indi = 0; indi < nInd; indi++) {
					...
					// TODO what if the 3 gls we are interested in are equal to each other for that sample? e.g. REF=A, ALT=C,G,T. We set major/ref/a1=A minor/alt/a2=C. But ind1 has only 1 G and 1 T observed, so A and C are both unobserved for ind1. What do we do in this case?
